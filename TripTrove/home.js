...
/* fetching weather */
let weatherApi = {
    weatherApiKey : "cb0d37c852fe4cf189e134656251003",
...
let flightapi = {
    flightAPIKey: "67ceef3f04d1fbb482bef365",
    ...
    flightDOM: function(data1) {
        ...
        data1.forEach(flight => {
            ...
            flightElement.innerHTML = `
                <h3 class="airline">${Airline}</h3>
                <div class="flight-time">
                    <p >${DepartureTime}</p>
                    <hr class="line-flight">
                    <p><i class='bx bxs-plane bx-rotate-90' ></i></p>
                    <p >${ArrivalTime}</p>
                </div>
                <div class="flight-nbr">
                    <h4 class="flight-info"><span>Flight Number: </span>${FlightNumber}</h4>
                </div>
                `;
...
submit.addEventListener("click", function() {
    ...
    /* in home page */
    const city1 = capitalizeFirstLetter(document.getElementById("city1").value);
    const city2 = capitalizeFirstLetter(document.getElementById("city2").value);
